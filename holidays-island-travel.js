        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/holidaysislandtravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    ...
    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-جزيرة-العطلات/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'ماليزيا - عرض الصيف الفاخر'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-جزيرة-العطلات/عروض-جورجيا/عرض-جورجيا-1.jpg', 'عرض جورجيا'],
    },
    ...
    {
        title: 'عروض تركيا',
        image_1: ['عروض-شركة-جزيرة-العطلات/عروض-تركيا/عرض-تركيا-1.jpg', 'تركيا - عرض الصيف الفاخر'],
    },
    ...
    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-جزيرة-العطلات/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'اذربيجان - عرض الصيف الفاخر'],
    },
    ...
    {
        title: 'عروض موريشوس',
        image_1: ['عروض-شركة-جزيرة-العطلات/عروض-موريشوس/عرض-موريشوس-1.jpg', 'عرض موريشوس للعيد وصيف 2024'],
    },

    {
        title: 'عروض هايدواي',
        image_1: ['عروض-شركة-جزيرة-العطلات/عروض-هايدواي/عرض-هايدواي-1.jpg', 'منتجع هايدواي - اربع ليالي'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966548098670?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/holidaysislandtravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة جزيرة العطلات على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة جزيرة العطلات على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة جزيرة العطلات على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة جزيرة العطلات للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة جزيرة العطلات للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة جزيرة العطلات`;
            img.title = `مكتب سياحي - شركة جزيرة العطلات`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966548098670";
